...
<div class="founders-story--content--story-image-container relative ">
  ...
  <cite>Tradeblock founder, Mbiyimoh Ghogomu analyzes his latest pre-release build.</cite>
</div>
...
<div class="content-resources mt-[48px] lg:grid lg:grid-cols-12 lg:gap-8">
  ...
  <div class="content-resources--right lg:col-span-8">
    <ul>
      <li><a href="#" target="_blank">AfroTech</a> – Sneaker Trading App Tradeblock To Disrupt The $30B Sneaker Resale Category With The Intro Of Public Offers</li>
      <li><a href="#" target="_blank">InnovationMap</a> — Houston 'sneakerheads' raise $8.9M to further develop digital marketplace</li>
      <li><a href="#" target="_blank">Sourcing Journal</a> — Why Former Nike and Jordan Brand Execs Backed This Sneaker Trading App</li>
      <li><a href="" target="_blank">The Business Journals</a> — Tradeblock raises $8.9M from investors to scale sneaker bartering marketplace</li>
      <li><a href="#" target="_blank">CultureMap Houston</a> - Clever Houston sneakerheads kick it with $8.9M in funding for innovative digital marketplace</li>
      <li><a href="#" target="_blank">Shoppe Black</a> - Black Owned Sneaker Brands You Should Know</li>
    </ul>
  </div>
</div>